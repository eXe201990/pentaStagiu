...
public class Flight {
    ...
    public Flight(String name, String destination, Date date, int flightDuration, int maxUserCapacity, StatusEnum status) {
        this.name = name;
    ...
    public void setDateTime(Date str){
        try{
    ...
    public void getUsers(){
        if(users.size() == 0){
            System.out.println("There are no registers users to flight " + getName());
            return;
        }
        System.out.println("The Fallowing Passengers are registred to the Flight " +getName());
